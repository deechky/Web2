...
namespace Gateway.Observability
{
    ...
    /// Prometheus/Loki, vidi docker-compose.observability.yml). Bez SqlClient instrumentacije - Gateway
    /// nema bazu. Isti obrazac je dupliran po servisu jer projekat nema deljenu biblioteku između
    /// servisa (analogno Health/HealthCheckResponseWriter.cs).
    /// </summary>
